...
export default function ModificarRecetaScreen() {
    ...
    const initialDescripcion = params.descripcion as string || '';
    const initialCantidadComensales = params.cantidadComensales ? params.cantidadComensales.toString() : '';
    const initialTiempoCoccion = params.tiempoCoccion ? params.tiempoCoccion.toString() : '';
    const initialDificultad = params.dificultad as string || '';
    const initialCategoria = params.categoria as string || '';
    const initialCocina = params.cocina as string || '';
    const initialImagen = params.imagen as string || '';
    const initialTags = params.tags ? JSON.parse(params.tags as string) : [];
    const initialIngredientes = params.ingredientes ? JSON.parse(params.ingredientes as string) : [];
    const initialPasos = params.pasos ? JSON.parse(params.pasos as string) : [''];

    // Estados del formulario
    const [titulo, setTitulo] = useState(initialTitulo);
    const [descripcion, setDescripcion] = useState(initialDescripcion);
    const [cantidadComensales, setCantidadComensales] = useState(initialCantidadComensales);
    const [tiempoCoccion, setTiempoCoccion] = useState(initialTiempoCoccion);
    const [dificultad, setDificultad] = useState(initialDificultad);
    const [categoria, setCategoria] = useState(initialCategoria);
    const [cocina, setCocina] = useState(initialCocina);
    const [imagen, setImagen] = useState(initialImagen);
    const [tags, setTags] = useState<string[]>(initialTags);
    const [ingredientes, setIngredientes] = useState<Ingredient[]>(initialIngredientes);
    const [pasos, setPasos] = useState<string[]>(initialPasos);
    ...
    const renderBasicInfo = () => (
        <View style={styles.stepContainer}>
            <Text style={styles.stepTitle}>Editar Información Básica</Text>
            {/* ...igual que crearReceta, pero con textos de edición... */}
            ...
            <View style={styles.inputGroup}>
                ...
                >
                    ...
                    <Text style={styles.addButtonText}>Editar Tags</Text>
                </TouchableOpacity>
    ...
    const renderIngredients = () => (
        <View style={styles.stepContainer}>
            <Text style={styles.stepTitle}>Editar Ingredientes</Text>
            <TouchableOpacity
                style={styles.addButton}
    ...
    const renderSteps = () => (
        <View style={styles.stepContainer}>
            <Text style={styles.stepTitle}>Editar Pasos de Preparación</Text>
            <FlatList
                data={pasos}
                keyExtractor={(item, index) => index.toString()}
                renderItem={({ item, index }) => (
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                <View style={styles.header}>
                    <Text style={styles.title}>Modificar Receta</Text>
